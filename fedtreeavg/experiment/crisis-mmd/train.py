...
from fedtreeavg.constants import constants
from fedtreeavg.trainers.server_trainer import Server
from fedtreeavg.model.mm_models import ImageTextClassifier
from fedtreeavg.dataloader.dataload_manager import DataloadManager

from fedtreeavg.trainers.fed_rs_trainer import ClientFedRS
from fedtreeavg.trainers.fed_avg_trainer import ClientFedAvg
from fedtreeavg.trainers.scaffold_trainer import ClientScaffold
from fedtreeavg.trainers.fed_tree_trainer import ClientFedTree
...
if __name__ == '__main__':
    ...
    if args.fed_alg in ['fed_avg', 'fed_prox', 'fed_opt', 'fed_tree']:
        Client = ClientFedAvg
    elif args.fed_alg in ['scaffold']:
        Client = ClientScaffold
    elif args.fed_alg in ['fed_rs']:
        Client = ClientFedRS
    elif args.fed_alg in ['fed_tree']:
        Client = ClientFedTree
